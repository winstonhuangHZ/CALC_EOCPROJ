...
\begin{frame}{Introduction To DE Calculation Approaches}
    \begin{columns}[c]
        ...
        \begin{figure}
            ...
            \caption{\footnotesize Comparison of the Runge-Kutta methods for the differential equation. Red line is the exact solution, 4th order Runge-Kutta is what we mainly use in this project, and is significantly more accurate. Figure from Wikimedia Commons, CC BY-SA 3.0 \ccby}
        \end{figure}
...
\begin{frame}{Euler's Method: Simple DE Approximation}
    \begin{columns}[c]
        ...
        \begin{figure}
            ...
            \caption{\footnotesize Illustration of the Euler method. The unknown curve is in blue, and its Euler approximation is in red. Figure from Wikimedia Commons, Public Domain. \ccZero}
        \end{figure}
        \column{0.4\textwidth}
    \end{columns}
\end{frame}
