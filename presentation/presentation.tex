...
\begin{frame}{Introduction To DE Calculation Approaches}
    \begin{columns}[c]
        ...
        \begin{figure}
            ...
            \caption{\footnotesize Comparison of the Runge-Kutta methods for the differential equation. Red line is the exact solution, 4th order Runge-Kutta is what we mainly use in this project, and is significantly more accurate. Figure from Wikicommon, CC BY-SA 3.0 \ccby}
        \end{figure}
